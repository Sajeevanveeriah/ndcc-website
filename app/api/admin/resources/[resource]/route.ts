...
const resourceMap: Record<string, ResourceConfig> = {
  ...
  merchWindows: { table: 'merch_order_windows', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin', 'committee'], deleteRoles: ['admin'], allowedFields: ['label', 'open_date', 'close_date', 'active', 'allow_queue_after_close'], defaultOrder: { column: 'open_date', ascending: false }, datetimeFields: ['open_date', 'close_date'] },
  ...
  raffleCampaigns: { table: 'raffle_campaigns', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin'], allowDelete: false, allowedFields: ['name', 'price_cents', 'draw_at', 'draw_label', 'active'], defaultOrder: { column: 'created_at', ascending: false }, datetimeFields: ['draw_at'] },
