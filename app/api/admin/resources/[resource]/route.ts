...
const resourceMap: Record<string, ResourceConfig> = {
  ...
  news: { table: 'news', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin'], allowedFields: ['title', 'content', 'author', 'published', 'published_at'], defaultOrder: { column: 'created_at', ascending: false }, datetimeFields: ['published_at'] },
  ...
  apparelProducts: { table: 'apparel_products', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin'], allowedFields: ['slug', 'name', 'description', 'price', 'sizes', 'customisable', 'active'], defaultOrder: { column: 'created_at', ascending: false } },
  ...
  kitchenItems: { table: 'kitchen_items', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin'], allowedFields: ['menu_id', 'name', 'description', 'price', 'is_available', 'is_hidden', 'sort_order'], defaultOrder: { column: 'sort_order', ascending: true } },
