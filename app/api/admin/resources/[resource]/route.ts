...
const resourceMap: Record<string, ResourceConfig> = {
  ...
  siteSettings: { table: 'site_settings', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin', 'president', 'secretary', 'committee'], allowedFields: ['key', 'label', 'value', 'field_type', 'group_label', 'is_public', 'sort_order'], defaultOrder: { column: 'sort_order', ascending: true } },
  navigationLinks: { table: 'navigation_links', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin', 'president', 'secretary', 'committee'], allowedFields: ['label', 'href', 'group_label', 'sort_order', 'is_active'], defaultOrder: { column: 'sort_order', ascending: true } },
  teams: { table: 'teams', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin', 'president', 'secretary', 'committee'], allowedFields: ['name', 'grade', 'description', 'captain', 'playhq_url', 'sort_order', 'is_active'], defaultOrder: { column: 'sort_order', ascending: true } },
  sponsorTiers: { table: 'sponsor_tiers', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin'], allowedFields: ['value', 'label', 'sort_order', 'is_active'], defaultOrder: { column: 'sort_order', ascending: true } },
  enquiryTypes: { table: 'enquiry_types', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin'], allowedFields: ['value', 'label', 'sort_order', 'is_active'], defaultOrder: { column: 'sort_order', ascending: true } },
  publicDownloads: { table: 'public_downloads', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin', 'president', 'secretary', 'committee'], allowedFields: ['title', 'href', 'category', 'description', 'sort_order', 'is_active'], defaultOrder: { column: 'sort_order', ascending: true } },
  achievements: { table: 'achievements', readRoles: ['admin', 'president', 'secretary', 'committee'], writeRoles: ['admin', 'president', 'secretary', 'committee'], allowedFields: ['title', 'description', 'image_url', 'alt_text', 'season_label', 'sort_order', 'is_active'], defaultOrder: { column: 'sort_order', ascending: true } },
};
...
const revalidationPaths: Record<string, string[]> = {
  ...
  contentBlocks: ['/', '/about', '/facilities', '/fixtures', '/merchandise', '/teams', '/events', '/join', '/kitchen', '/sponsors', '/gallery', '/volunteer', '/contact'],
  siteSettings: ['/', '/about', '/facilities', '/fixtures', '/merchandise', '/teams', '/events', '/join', '/kitchen', '/sponsors', '/gallery', '/volunteer', '/contact'],
  navigationLinks: ['/', '/about', '/facilities', '/fixtures', '/merchandise', '/teams', '/events', '/join', '/kitchen', '/sponsors', '/gallery', '/volunteer', '/contact'],
  teams: ['/teams', '/fixtures'],
  sponsorTiers: ['/', '/sponsors'],
  enquiryTypes: ['/contact'],
  publicDownloads: ['/sponsors'],
