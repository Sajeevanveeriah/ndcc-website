  ...
  return (
    <Card>
      <CardContent className="p-6 space-y-4">
        ...
        {mode === 'account' && manager && rulesVersion && manager.rules_version_accepted !== rulesVersion && <p role="status" className="rounded-lg border p-4">Dino Coach now has a 15 million Dino Dollar budget, a live wallet and player trading. Read the updated rules, tick the acceptance box and save your profile before changing your team.</p>}
