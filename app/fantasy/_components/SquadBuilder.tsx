...
export default function SquadBuilder({ readonlyMode = false }: { readonlyMode?: boolean }) {
  ...
  return <div className="space-y-6">
    ...
    {!readonlyMode && eligibilityIssues.some(issue => issue.code === 'rules') && <div className="rounded-lg border border-amber-300 bg-amber-50 p-4 text-amber-950">
      ...
      <p className="my-2">The budget is {Number(settings.budget_dino_dollars) > 0 ? money(Number(settings.budget_dino_dollars)) : '15 million Dino Dollars'}. Players can be sold back to the pool; inter-team trades are unavailable. Your selected players will stay on this page.</p>
