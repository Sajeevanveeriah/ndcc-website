              ...
              {rulesParagraphs.length > 0 ? (
                <Card>
                  <CardContent className="p-6 md:p-8">
                    <h2 className="text-2xl font-display font-bold text-maroon-800 dark:text-maroon-200 mb-4">{rulesBlock?.title || 'Fantasy Cricket Rules'}</h2>
                    <div className="space-y-3 text-content-secondary font-body leading-relaxed">
            ...
            <aside className="lg:sticky lg:top-24 h-fit">
              <Card className="border-l-4 border-l-maroon-700">
                <CardContent className="p-6">
                  <h2 className="text-xl font-display font-bold text-content-primary mb-3">MVP note</h2>
