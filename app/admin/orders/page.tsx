...
export default function AdminOrdersPage() {
  ...
  return (
    <div>
      ...
      {group === 'merch' && <p className="mb-4 text-sm">Full payment is required before apparel orders can be processed or included in the supplier export. Balance reminders run every three weeks from the order date. <a className="underline" href="/pay-balance" target="_blank" rel="noreferrer">Open balance payment page</a></p>}
