...
for (const href of ['/admin/events','/admin/news','/admin/publications','/admin/teams','/admin/fantasy','/admin/sponsors','/admin/orders','/admin/users','/admin/season/new','/admin/season/registration','/admin/fantasy/reconciliation']) assert.match(layout, new RegExp(`href: '${href.replace(/\//g, '\\/')}'`));
