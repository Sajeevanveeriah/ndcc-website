...
assert.match(route, /requireSession\(\['admin', 'president', 'secretary', 'committee'\]\)/, 'Unauthenticated requests go through session guard.');
...
assert.match(orders, /handleSetPaid/, 'Existing order paid action remains present.');
