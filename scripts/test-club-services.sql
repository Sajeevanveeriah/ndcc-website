...
begin;
do $$
declare actor uuid; denied uuid; key uuid:=gen_random_uuid(); sale jsonb; replay jsonb; oid uuid; jid uuid; worker uuid:=gen_random_uuid(); claimed record; campaign uuid; before_n integer;
begin
