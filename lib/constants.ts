...
export const SEED_NEWS: Omit<NewsPost, 'created_at'>[] = [
  {
    id: 'seed-premiership-success-2026',
    title: 'Dinos celebrate senior and junior premiership success',
    content:
...
Congratulations to everyone involved in the Division 4 1st Eleven premiership, the Division 4 Club Championship, and the Under 13 Juniors premiership.`,
    author: 'NDCC',
    published: true,
    published_at: '2026-05-30T09:00:00+10:00',
    sort_order: -10,
    image_url: '',
  },
  {
